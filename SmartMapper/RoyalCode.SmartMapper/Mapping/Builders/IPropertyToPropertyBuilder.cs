...
public interface IPropertyToPropertyBuilder<TSource, TTarget, TSourceProperty, TTargetProperty>
    : IPropertyStrategyBuilder<TSourceProperty, TTargetProperty, IPropertyToPropertyBuilder<TSource, TTarget, TSourceProperty, TTargetProperty>>
{
    /// <summary>
    /// <para>
    ...
    /// </returns>
    IPropertyThenToBuilder<TSourceProperty, TTargetProperty, TNextProperty> ThenTo<TNextProperty>(
    ...
    ///     The builder to configure the property to property mapping.
    /// </returns>
    IPropertyThenBuilder<TSourceProperty, TTargetProperty> Then();
}
