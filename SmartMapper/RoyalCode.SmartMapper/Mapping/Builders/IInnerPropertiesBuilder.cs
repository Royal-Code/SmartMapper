...
public interface IInnerPropertiesBuilder<TSource, TTarget, TSourceProperty>
{
    /// <summary>
    /// <para>
    ...
    /// </returns>
    IPropertyBuilder<TSourceProperty, TTarget, TProperty> Map<TProperty>(Expression<Func<TSourceProperty, TProperty>> propertySelector);
    ...
    ///     A builder to configure the property mapping options.
    /// </returns>
    IPropertyBuilder<TSourceProperty, TTarget, TProperty> Map<TProperty>(string propertyName);
