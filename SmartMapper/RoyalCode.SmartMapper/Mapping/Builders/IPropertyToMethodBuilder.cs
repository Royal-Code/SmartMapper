...
public interface IPropertyToMethodBuilder<TTarget, TSourceProperty>
{
    /// <summary>
    /// <para>
    ...
    /// <returns></returns>
    void Parameters(Action<IPropertyToParametersBuilder<TSourceProperty>> configureParameters);
    ...
    /// </returns>
    IParameterBuilder<TSourceProperty> ToParameter(string? parameterName = null);
    ...
    IPropertyToMethodBuilder<TTarget, TSourceProperty> UseMethod(string name);
    ...
    /// <returns>The same instance for chained calls.</returns>
    IPropertyToMethodBuilder<TTarget, TSourceProperty> UseMethod(
